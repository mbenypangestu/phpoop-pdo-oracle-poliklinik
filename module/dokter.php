...
//            echo "Connection success";
    ...
    public function create($page, $params = []) {
        try {
            ...
            $sql    = "INSERT INTO $this->table (ID, ID_POLI, NAME, GENDER, ADDRESS, BIRTH_DAY, TELP) VALUES 
                      ($id, $params[id_poli], '$params[name]', '$params[gender]', '$params[address]', 
                      '$birthday', '$params[telp]')";
            $query  = $this->conn->prepare($sql);
            $query->execute();
